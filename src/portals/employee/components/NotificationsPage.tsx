  ...
  useEffect(() => {
    const mockNotifications: Notification[] = [
      ...
      },
      {
        ...
        message: 'Your manager has sent you a message regarding the quarterly review meeting.',
      ...
      },
      {
        ...
        message: 'You have successfully completed the training module on workplace safety.',
      ...
      },
      {
        ...
        category: 'system',
        title: 'System Update',
        message: 'The HR system will undergo maintenance this weekend. Please save your work.',
      ...
      },
      {
        ...
        message: 'Your timesheet for the week has been submitted and is awaiting approval.',
      ...
      },
      {
        ...
        message: 'You have only 3 days of annual leave remaining for this year.',
      ...
      },
      {
        ...
        message: 'You have been assigned a new task: Review Q4 Sales Report.',
  ...
  return (
    <div className="p-4 md:p-6 max-w-7xl mx-auto">
      ...
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-600 mt-1">Stay updated with important alerts and updates</p>
      </div>
                    ...
                    {notification.actionUrl && (
                      <Button
                        ...
                        onClick={() => {
                          ...
                          // Employee portal uses in-app navigation - just mark as read
                          // The actionUrl is informational only
                        }}
                      >
                        Mark as Read →
                      </Button>
