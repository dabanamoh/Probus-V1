...
const Employees = () => {
  ...
  return <div className="flex min-h-screen bg-gray-50 w-full">
      <Sidebar />
      <div className="flex-1 p-8">
        ...
        {/* Table */}
        <div className="rounded-lg shadow-sm border bg-sky-600 hover:bg-sky-500">
          <Table>
            <TableHeader>
            ...
            <TableBody>
              {isLoading ? <TableRow>
                ...
                </TableRow> : employees && employees.length > 0 ? employees.map((employee, index) => <TableRow key={employee.id} className={index % 2 === 0 ? "bg-white" : "bg-gray-50"}>
                    <TableCell>
                      <div className="flex items-center space-x-3">
                        <img src={employee.profile_image_url || '/placeholder.svg'} alt={employee.name} className="w-10 h-10 rounded-full object-cover" />
                        <div>
